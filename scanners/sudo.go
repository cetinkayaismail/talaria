...
// CriticalSudoCommands: Direct shell escape - these ALWAYS allow privesc without conditions
...
// ConditionalSudoCommands: Can enable privesc in exploitable combinations
